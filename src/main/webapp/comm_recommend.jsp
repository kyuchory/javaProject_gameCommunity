...
<div class="comm_head_rec">
	<div class="comm_header">
		...
		<div class="comm_header_tap">
			...
			--><span class="comm_header_tap_obj_rec"><br><a style="color:white" href="comm_free.jsp">자유</a></span><!--  
...
<button class="comm_table_new" type="button" onclick="location.href='comm_recommend_write.jsp'">글작성</button>
</div>
</body>
</html>