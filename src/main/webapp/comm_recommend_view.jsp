...
<body>
	...
	Community comm = communityRecommendDaoImpl.selectByNum(num);
	...
	<div style="width: 67%; margin: auto">
		<div>
			<span class="comm_table_cap">게임추천</span> <span id="comm_view_button">
				<button style="cursor:pointer" id="comm_view_button"
					onclick="location.href='comm_recommend.jsp'">돌아가기</button>
			</span>
		</div>
	...
	<div style="width: 67%; margin: auto">
		...
		<table class="comm_table">
			...
			%>
			<tr>
				<td style="text-align:left;width:58%;padding-left:50px"><a href="comm_recommend_view.jsp?num=<%=board.getNum()%>"><%=board.getSubject()%></a></td>
				<th class="comm_table_space"></th>
