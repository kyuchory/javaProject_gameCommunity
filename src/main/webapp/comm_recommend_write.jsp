...
<body><jsp:include page="header_header.jsp"/>
<jsp:include page="main_banner.jsp"/>
<div class="comm_head_rec">
	<div class="comm_header">
		<div class="comm_header_index">
			<h1 style="font-size:35px;color:white"><br>커뮤니티</h1>
			<p style="color:white">소식을 공유해 보세요</p>	
		</div>
		<div class="comm_header_tap">
			<span class="comm_header_tap_picked"><br><a href="comm_recommend.jsp">게임추천</a></span><!--  
			--><span class="comm_header_tap_obj_rec"><br><a style="color:white" href="comm_free.jsp">자유게시판</a></span><!--  
			--><span class="comm_header_tap_obj_rec"><br><a style="color:white"href="comm_news.jsp">게임소식</a></span>
		</div>
	</div>
</div>
...
<div style="width:67%;margin:auto">
	...
	<div class="comm_write_box">
		<form action="comm_recommend_writeProcess.jsp" method="post">
			<div class="comm_write_box_sub"> 
				 제목 &nbsp;&nbsp;<input class="comm_write_box_sub_input" type="text" name="subject" placeholder="제목을 입력하세요" >
			 </div>
			<textarea class="comm_write_box_cont" name="content" placeholder="여기에 내용을 입력하세요"></textarea>
			<div style="height:100px"></div>
