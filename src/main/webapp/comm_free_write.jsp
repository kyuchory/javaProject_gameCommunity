...
<div class="comm_head_free">
	<div class="comm_header">
		...
		<div class="comm_header_tap">
			<span class="comm_header_tap_obj_free"><br><a style="color:white" href="comm_recommend.jsp">추천</a></span><!--  
			--><span class="comm_header_tap_picked"><br><a  href="comm_free.jsp">자유</a></span><!--  
