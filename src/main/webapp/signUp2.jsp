...
<div class="layoutDku">
	...
	<table class="table1">
		...
		<tr>
			...
			<td class="name2"><input type="radio" class="inputRadio" name="spec">최하
			<input type="radio" class="inputRadio" name="email">하
			<input type="radio" class="inputRadio" name="email">중
			<input type="radio" class="inputRadio" name="email">상
			<input type="radio" class="inputRadio" name="email">최상	
			</td>
		</tr>
	</table>
